        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-norelle-text-muted leading-relaxed">
                {product.description}
              </p>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div className="flex flex-col items-center space-y-2">
                  ...
                  <span className="text-xs text-norelle-text-muted">2 Year Warranty</span>
                </div>
                <div className="flex flex-col items-center space-y-2">
              ...
              <div className="grid md:grid-cols-2 gap-6 text-sm">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-norelle-cream">{product.weight}g</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <div className="flex justify-between">
                  ...
                  <div className="flex justify-between">
                    <span className="text-norelle-text-muted">Stock</span>
                    <span className="text-norelle-cream">{product.stock} available</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            ...
            <p className="text-norelle-text-muted max-w-2xl mx-auto">
              Discover pieces that complement your selection and create a cohesive, elegant look.
            </p>
          </div>
          ...
          <div className="text-center py-12">
            <p className="text-norelle-text-muted mb-8">
              More exquisite pieces coming soon...
            </p>
